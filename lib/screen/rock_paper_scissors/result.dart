...
class GameResultScreen extends StatefulWidget {
  GameResultScreen(this.gameChoice, {Key? key}) : super(key: key);
  GameChoice gameChoice;
  @override
  _GameScreenState createState() => _GameScreenState();
}

class _GameScreenState extends State<GameResultScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    switch (robotChoice) {
      case "Rock":
        robotChoicePath = "assets/rock_paper_scissor/rock_btn.png";
        break;
      case "Paper":
        robotChoicePath = "assets/rock_paper_scissor/paper_btn.png";
        break;
      case "Scisors":
        robotChoicePath = "assets/rock_paper_scissor/scisor_btn.png";
        break;
      default:
    }
    ...
    switch (widget.gameChoice.type) {
      case "Rock":
        player_choice = "assets/rock_paper_scissor/rock_btn.png";
        break;
      case "Paper":
        player_choice = "assets/rock_paper_scissor/paper_btn.png";
        break;
      case "Scisors":
        player_choice = "assets/rock_paper_scissor/scisor_btn.png";
        break;
      default:
    }
